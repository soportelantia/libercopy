          ...
          <div className="bg-white rounded-lg shadow-lg p-8 space-y-8">
            ...
            <section>
              ...
              <ul className="text-gray-700 space-y-2 list-disc list-inside">
                <li>
                  Si no está conforme con todas y cada una de estas cláusulas y condiciones absténgase de utilizar este
                  sitio web.
                </li>
            ...
            <section>
              ...
              <p className="text-gray-700 mb-4">
                ...
                que permita a terceros publicar contenidos de forma independiente en la página web del prestador.
              </p>
              <p className="text-gray-700">
                Sin embargo, y en cumplimiento de lo dispuesto en los artículos 11 y 16 de la LSSI-CE, LiberCopy se pone
                a disposición de todos los usuarios, autoridades y fuerzas de seguridad, colaborando de forma activa en
                la retirada o en su caso bloqueo de todos aquellos contenidos que puedan afectar o contravenir la
            ...
            <section>
              ...
              <p className="text-gray-700">
                LiberCopy se reserva el derecho de efectuar sin previo aviso las modificaciones que considere oportunas
