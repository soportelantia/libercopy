          ...
          <div className="bg-white rounded-lg shadow-lg p-8 space-y-8">
            ...
            <section>
              ...
              <p className="text-gray-700">
                ...
                que fueron recogidos y, en todo caso, durante los plazos establecidos por la legislación aplicable. Los
                datos de facturación se conservarán durante el plazo legalmente establecido (6 años desde la última
                anotación).
              </p>
            </section>
            ...
            <section>
              ...
              <p className="text-gray-700">
                ...
                el acceso no autorizado, la alteración, divulgación o destrucción. Utilizamos cifrado SSL, acceso
                restringido y sistemas de backup seguros.
              </p>
            </section>
            ...
            <section>
              ...
              <p className="text-gray-700">
                Utilizamos cookies para mejorar la funcionalidad de nuestro sitio web y analizar el uso del mismo. Para
            ...
            <section>
              ...
              <p className="text-gray-700">
                Si considera que el tratamiento de sus datos personales no se ajusta a la normativa, puede presentar una
