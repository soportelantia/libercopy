...
import { Tag, X, Check, AlertCircle, CreditCard } from "lucide-react"
...
export default function CheckoutSummaryPage() {
  ...
  const handleProceedToPayment = () => {
    // Guardar información del descuento para el pago
    if (appliedDiscount) {
        ...
        <div className="space-y-6">
          ...
          <Card>
            ...
            <CardContent className="space-y-4">
              ...
              <Button onClick={handleProceedToPayment} className="w-full" size="lg" disabled={isProcessing}>
