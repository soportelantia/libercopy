...
export const metadata: Metadata = {
  ...
  ...generateCanonicalMetadata("/condiciones-compra"),
}
          ...
          <div className="max-w-4xl mx-auto">
            <div className="bg-white rounded-lg shadow-lg p-8 space-y-8">
              ...
              <section>
                ...
                <div className="space-y-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-700">
                      Una vez realizado el pedido, el cliente recibirá un email de confirmación con los detalles del
                      mismo y el número de pedido.
                    </p>
                  </div>
                  <div>
                    <h3 className="font-semibold text-gray-900 mb-2">3.3 Revisión Técnica</h3>
                    <p className="text-gray-700">
                      LiberCopy se reserva el derecho de revisar los archivos y contactar al cliente si detecta
                      problemas técnicos que puedan afectar la calidad del resultado final.
                    </p>
                  </div>
                </div>
              </section>
              ...
              <section>
                ...
                <div className="space-y-4">
                  <div>
                    ...
                    <p className="text-gray-700">
                      Los precios mostrados en el sitio web incluyen IVA. LiberCopy se reserva el derecho de modificar
                      los precios sin previo aviso, aunque respetará los precios vigentes en el momento de la
                  ...
                  <div>
                    ...
                    <p className="text-gray-700">
                      Se aceptan las siguientes formas de pago: tarjeta de crédito/débito, PayPal, transferencia
                      bancaria y Bizum. El pago debe realizarse antes del inicio de la producción.
                    </p>
                  </div>
                </div>
              </section>
              ...
              <section>
                ...
                <div className="space-y-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-700">
                      LiberCopy no se hace responsable de retrasos o daños causados por la empresa de transporte. En
                      caso de incidencias, colaboraremos en la gestión de reclamaciones.
                    </p>
                  </div>
                </div>
              </section>
              ...
              <section>
                ...
                <p className="text-gray-700">
                  Debido a la naturaleza personalizada de nuestros servicios, no se admite el derecho de desistimiento
                  una vez iniciada la producción. El cliente puede cancelar el pedido únicamente antes del inicio de la
              ...
              <section>
                ...
                <div className="space-y-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-700">
                      Las reclamaciones por defectos deben comunicarse en un plazo máximo de 7 días desde la recepción
                      del pedido.
                    </p>
                  </div>
                </div>
              ...
              <section>
                ...
                <p className="text-gray-700">
                  ...
                  impresión, o contar con la autorización necesaria para su reproducción. LiberCopy no se hace
                  responsable del uso indebido de contenidos protegidos por derechos de autor.
                </p>
              </section>
              ...
              <section>
                ...
                <p className="text-gray-700">
                  LiberCopy se reserva el derecho de modificar estas condiciones en cualquier momento. Las
